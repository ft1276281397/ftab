...
// 导入YonghuDao接口，用于数据库操作
import com.dao.YonghuDao;
// 导入YonghuEntity实体类，用于映射用户表
import com.entity.YonghuEntity;
// 导入YonghuService接口，用于定义用户服务
import com.service.YonghuService;
// 导入YonghuView视图类，用于用户视图展示
...
// 注解，用于声明事务管理
@Transactional
// 继承ServiceImpl基类，实现YonghuService接口
public class YonghuServiceImpl extends ServiceImpl<YonghuDao, YonghuEntity> implements YonghuService {

    /**
     * 根据分页参数查询用户列表视图
     *
     * 该方法用于根据传入的分页参数查询用户列表视图，并返回分页结果
     *
